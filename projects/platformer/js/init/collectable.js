(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 200, 100, 3, 0.7);
        collectable.create(type.grace, 600, 99, 8, 0.7);
        collectable.create(type.db,700, 150, 9, 0.7);
        collectable.create(type.kennedi,800, 200, 10, 0.7);
